...
# curl -s https://raw.githubusercontent.com/pedroaugustoferreira/service-amazonas-/master/install-zabbix-ibm-power-aix6.1.sh | bash -s --
...
wget https://www.zabbix.com/downloads/1.8.3/zabbix_agent-1.8.3-aix-6.1.04-powerpc.tar.gz

gzip -d zabbix_agent-1.8.3-aix-6.1.04-powerpc.tar.gz

tar -xf zabbix_agent-1.8.3-aix-6.1.04-powerpc.tar
